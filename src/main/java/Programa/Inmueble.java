...
public class Inmueble implements Serializable {
    ...
    private InfoInmuebles datosInmueble;
    ...
    //Constructor
    public Inmueble(String titulo, String descripcion, Direccion direccion, InfoInmuebles datosInmueble, String tipo, double precioNoche, String fotografia, String servicios) {
        this.titulo = titulo;
     ...
     */
    public InfoInmuebles getDatosInmueble() {
     ...
     */
    public void setDatosInmueble(InfoInmuebles datosInmueble) {
        this.datosInmueble = datosInmueble;
    }
